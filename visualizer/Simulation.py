...
class Simulation:
    ...
    def run(self):
        ...
        self.normal_obus.append(OBUNormal('obu2', 3, '192.168.98.30', '6e:06:e0:03:00:03', 'obu2', 0, [40.63269414127195, -8.65525513907526], (4,5), graph=self.graph, obu_emergency=self.special_obus[0]))
        self.normal_obus.append(OBUNormal('obu3', 7, '192.168.98.70', '6e:06:e0:03:00:07', 'obu3', 0, [40.6322218272483, -8.655029797050233], (4,5), graph=self.graph, obu_emergency=self.special_obus[0]))
        
        self.rsus.append(RSU('rsu1', 1, '192.168.98.10', '6e:06:e0:03:00:01', 'rsu1', [40.6334546665471, -8.654870575236478], special_vehicle=self.special_obus[0]))
